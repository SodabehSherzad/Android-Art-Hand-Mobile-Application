...
public class CartViewModel {
    ...
    public CartViewModel(int id, int user_id, int product_id, String productName, String productImage, String productColor, String productDetail, String productDimension, int productNumber, double productSize, double productWeight, double productPrice) {
        this.id = id;
    ...
    public CartViewModel(int id, int user_id, int product_id) {
        this.id = id;
        this.user_id = user_id;
        this.product_id = product_id;
    }
