...
public class StatusOrderAdapter extends RecyclerView.Adapter<StatusOrderAdapter.ViewHolder> {
    ...
    public StatusOrderAdapter(Context context, List<Model> list, DatabaseHelper databaseHelper) {
        this.list = list;
    ...
    @NonNull
    @Override
    public StatusOrderAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.activity_status_order_item, parent, false);
        return new StatusOrderAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull StatusOrderAdapter.ViewHolder holder, int position) {
